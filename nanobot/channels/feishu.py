...
class FeishuChannel(BaseChannel):
    ...
    def _on_message_sync(self, data: Any) -> None:
        ...
        """
        logger.info("Feishu: _on_message_sync called with data type={}", type(data).__name__)
        if self._loop and self._loop.is_running():
            asyncio.run_coroutine_threadsafe(self._on_message(data), self._loop)
        else:
            logger.warning("Feishu: event loop not available, loop={}, running={}", self._loop, self._loop.is_running() if self._loop else None)
    ...
    async def _on_message(self, data: Any) -> None:
        ...
        try:
            ...
            logger.info("Feishu: received message from sender_id={}, chat_id={}, msg_type={}", sender_id, chat_id, msg_type)
            logger.debug("Feishu: allow_from config = {}", self.config.allow_from)
